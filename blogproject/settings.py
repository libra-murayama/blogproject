...
DEFAULT_FROM_EMAIL = 'neugate.murayama@gmail.com'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'smtp.gmail.com'            # GmailのSMTPサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = 'neugate.murayama@gmail.com'     # Gmailのアドレスを入力
EMAIL_HOST_PASSWORD = 'dcedoctnjfrsbbha' # Gmailのアプリ用パスワードを入力
